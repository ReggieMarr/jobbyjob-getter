...
\DeclareRobustCommand{\canoe}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{canoe}%
  \endgroup
}

\DeclareRobustCommand{\violin}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{violin}%
  \endgroup
}

\DeclareRobustCommand{\hockey}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{hockey}%
  \endgroup
}

\DeclareRobustCommand{\snowboard}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{snowboard}%
  \endgroup
}

\DeclareRobustCommand{\tent}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{tent}%
  \endgroup
}

\DeclareRobustCommand{\sailing-boat}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{sailing-boat}%
  \endgroup
}

\DeclareRobustCommand{\mandolin}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{mandolin}%
  \endgroup
}
...
\section{About Me {\raggedright \hockey{} \canoe{} \tent{} \snowboard{} \sailing-boat{} \mandolin{} \violin{}}}

...
\item Capstone - Developed G-Code Generator Cross platform application (Qt \& C++) from 3D CAD models for novel metal 3D printing process.\\
\item Level 600 Project - Developed a neural network and network industrial system for modeling and controlling the distillation of ethanol.\\
\item Completed 16 Months Co-Op\\
\end{itemize}
